...
export function useVirtualizer_unstable(props: VirtualizerProps): VirtualizerState {
  ...
  const actualIndex = virtualizerContext ? virtualizerContext.contextIndex : virtualizerStartIndex;
  const setActualIndex = virtualizerContext ? virtualizerContext.setContextIndex : setVirtualizerStartIndex;
